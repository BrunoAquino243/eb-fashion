    ...
    if (categoriesSection) {
        ...
        categories.forEach(category => {
            const categoryImage = getCategoryImage(category.slug) || 
                                 (category.slug === 'camisas' ? 'images/categories/camisas.jpg' : 
                                  category.slug === 'moletons' ? 'images/categories/moletons.jpg' : 
                                  category.slug === 'calcas' ? 'images/categories/calcas.jpg' : 
                                  category.slug === 'blusas' ? 'images/categories/blusas.jpg' : 
            ...
            categoryCard.innerHTML = `
                <a href="products.html?category=${category.slug}">
                    <img src="${categoryImage}" alt="${category.name}" class="category-img" onerror="this.src='images/categories/default.jpg'">
...
function addToCartFromDetails(productId) {
    ...
    // Obter o tamanho selecionado, se disponível
